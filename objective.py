...
def objective_21(x, a, b, c):
    return a+b*(x)+c*(x)*(np.log(x))

def objective_22(x, a, b, c):
    return a+b*(x)+c*(x)**(1.5)

def objective_23(x, a, b, c):
    return a+b*(x)+c*((x)**(2))

def objective_24(x, a, b, c):
    return a+b*(x)+c*((x)**(2))*(np.log(x))

def objective_25(x, a, b, c):
    return a+b*(x)+c*(x)**(2.5)

def objective_26(x, a, b, c):
    return a+b*(x)+c*((x)**(3))

def objective_27(x, a, b, c):
    return a+b*(x)+c*(np.e)**(x)

def objective_28(x, a, b, c):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))

def objective_29(x, a, b, c):
    return a+b*(x)+c*((np.log(x)))**(2)

def objective_30(x, a, b, c):
    return a+b*(x)+c*(x)/(np.log(x))

def objective_31(x, a, b, c):
    return a+b*(x)+c*(x)**(0.5)

def objective_32(x, a, b, c):
    return a+b*(x)+c*(np.log(x))

def objective_33(x, a, b, c):
    return a+b*(x)+c/(np.log(x))

def objective_34(x, a, b, c):
    return a+b*(x)+c/(x)**(0.5)

def objective_35(x, a, b, c):
    return a+b*(x)+c*(np.log(x))/(x)

def objective_36(x, a, b, c):
    return a+b*(x)+c/(x)

def objective_37(x, a, b, c):
    return a+b*(x)+c/(x)**(1.5)

def objective_38(x, a, b, c):
    return a+b*(x)+c*(np.log(x))/((x)**(2))

def objective_39(x, a, b, c):
    return a+b*(x)+c/((x)**(2))

def objective_40(x, a, b, c):
    return a+b*(x)+c*(np.e)**((-x))

def objective_41(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)

def objective_42(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*((x)**(2))

def objective_43(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))

def objective_44(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)

def objective_45(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*((x)**(3))

def objective_46(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)

def objective_47(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))

def objective_48(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)

def objective_49(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))

def objective_50(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)

def objective_51(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(np.log(x))

def objective_52(x, a, b, c):
    return a+b*(x)*(np.log(x))+c/(np.log(x))

def objective_53(x, a, b, c):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)

def objective_54(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)

def objective_55(x, a, b, c):
    return a+b*(x)*(np.log(x))+c/(x)

def objective_56(x, a, b, c):
    return a+b*(x)*(np.log(x))+c/(x)**(1.5)

def objective_57(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/((x)**(2))

def objective_58(x, a, b, c):
    return a+b*(x)*(np.log(x))+c/((x)**(2))

def objective_59(x, a, b, c):
    return a+b*(x)*(np.log(x))+c*(np.e)**((-x))

def objective_60(x, a, b, c):
    return a+b*(x)**(1.5)+c*((x)**(2))

def objective_61(x, a, b, c):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))

def objective_62(x, a, b, c):
    return a+b*(x)**(1.5)+c*(x)**(2.5)

def objective_63(x, a, b, c):
    return a+b*(x)**(1.5)+c*((x)**(3))

def objective_64(x, a, b, c):
    return a+b*(x)**(1.5)+c*(np.e)**(x)

def objective_65(x, a, b, c):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))

def objective_66(x, a, b, c):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)

def objective_67(x, a, b, c):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))

def objective_68(x, a, b, c):
    return a+b*(x)**(1.5)+c*(x)**(0.5)

def objective_69(x, a, b, c):
    return a+b*(x)**(1.5)+c*(np.log(x))

def objective_70(x, a, b, c):
    return a+b*(x)**(1.5)+c/(np.log(x))

def objective_71(x, a, b, c):
    return a+b*(x)**(1.5)+c/(x)**(0.5)

def objective_72(x, a, b, c):
    return a+b*(x)**(1.5)+c*(np.log(x))/(x)

def objective_73(x, a, b, c):
    return a+b*(x)**(1.5)+c/(x)

def objective_74(x, a, b, c):
    return a+b*(x)**(1.5)+c/(x)**(1.5)

def objective_75(x, a, b, c):
    return a+b*(x)**(1.5)+c*(np.log(x))/((x)**(2))

def objective_76(x, a, b, c):
    return a+b*(x)**(1.5)+c/((x)**(2))

def objective_77(x, a, b, c):
    return a+b*(x)**(1.5)+c*(np.e)**((-x))

def objective_78(x, a, b, c):
    return a+b*((x)**(2))+c*((x)**(2))*(np.log(x))

def objective_79(x, a, b, c):
    return a+b*((x)**(2))+c*(x)**(2.5)

def objective_80(x, a, b, c):
    return a+b*((x)**(2))+c*((x)**(3))

def objective_81(x, a, b, c):
    return a+b*((x)**(2))+c*(np.e)**(x)

def objective_82(x, a, b, c):
    return a+b*((x)**(2))+c*(x)**(0.5)*(np.log(x))

def objective_83(x, a, b, c):
    return a+b*((x)**(2))+c*((np.log(x)))**(2)

def objective_84(x, a, b, c):
    return a+b*((x)**(2))+c*(x)/(np.log(x))

def objective_85(x, a, b, c):
    return a+b*((x)**(2))+c*(x)**(0.5)

def objective_86(x, a, b, c):
    return a+b*((x)**(2))+c*(np.log(x))

def objective_87(x, a, b, c):
    return a+b*((x)**(2))+c/(np.log(x))

def objective_88(x, a, b, c):
    return a+b*((x)**(2))+c/(x)**(0.5)

def objective_89(x, a, b, c):
    return a+b*((x)**(2))+c*(np.log(x))/(x)

def objective_90(x, a, b, c):
    return a+b*((x)**(2))+c/(x)

def objective_91(x, a, b, c):
    return a+b*((x)**(2))+c/(x)**(1.5)

def objective_92(x, a, b, c):
    return a+b*((x)**(2))+c*(np.log(x))/((x)**(2))

def objective_93(x, a, b, c):
    return a+b*((x)**(2))+c/((x)**(2))

def objective_94(x, a, b, c):
    return a+b*((x)**(2))+c*(np.e)**((-x))

def objective_95(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(x)**(2.5)

def objective_96(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*((x)**(3))

def objective_97(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(np.e)**(x)

def objective_98(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(x)**(0.5)*(np.log(x))

def objective_99(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*((np.log(x)))**(2)

def objective_100(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(x)/(np.log(x))

def objective_101(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(x)**(0.5)

def objective_102(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c*(np.log(x))

def objective_103(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c/(np.log(x))

def objective_104(x, a, b, c):
    return a+b*((x)**(2))*(np.log(x))+c/(x)**(0.5)
...
def objective_231(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(x)**(1.5)

def objective_232(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*((x)**(2))

def objective_233(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*((x)**(2))*(np.log(x))

def objective_234(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(x)**(2.5)

def objective_235(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*((x)**(3))

def objective_236(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(np.e)**(x)

def objective_237(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(x)**(0.5)*(np.log(x))

def objective_238(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*((np.log(x)))**(2)

def objective_239(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(x)/(np.log(x))

def objective_240(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(x)**(0.5)

def objective_241(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(np.log(x))

def objective_242(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d/(np.log(x))

def objective_243(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d/(x)**(0.5)

def objective_244(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(np.log(x))/(x)

def objective_245(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d/(x)

def objective_246(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d/(x)**(1.5)

def objective_247(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_248(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d/((x)**(2))

def objective_249(x, a, b, c, d):
    return a+b*(x)+c*(x)*(np.log(x))+d*(np.e)**((-x))

def objective_250(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*((x)**(2))

def objective_251(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*((x)**(2))*(np.log(x))

def objective_252(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(x)**(2.5)

def objective_253(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*((x)**(3))

def objective_254(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(np.e)**(x)

def objective_255(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(x)**(0.5)*(np.log(x))

def objective_256(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*((np.log(x)))**(2)

def objective_257(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(x)/(np.log(x))

def objective_258(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(x)**(0.5)

def objective_259(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(np.log(x))

def objective_260(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d/(np.log(x))

def objective_261(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d/(x)**(0.5)

def objective_262(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(np.log(x))/(x)

def objective_263(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d/(x)

def objective_264(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d/(x)**(1.5)

def objective_265(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(np.log(x))/((x)**(2))

def objective_266(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d/((x)**(2))

def objective_267(x, a, b, c, d):
    return a+b*(x)+c*(x)**(1.5)+d*(np.e)**((-x))

def objective_268(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*((x)**(2))*(np.log(x))

def objective_269(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(x)**(2.5)

def objective_270(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))

def objective_271(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(np.e)**(x)

def objective_272(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(x)**(0.5)*(np.log(x))

def objective_273(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*((np.log(x)))**(2)

def objective_274(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(x)/(np.log(x))

def objective_275(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(x)**(0.5)

def objective_276(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(np.log(x))

def objective_277(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d/(np.log(x))

def objective_278(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d/(x)**(0.5)

def objective_279(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(np.log(x))/(x)

def objective_280(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d/(x)

def objective_281(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d/(x)**(1.5)

def objective_282(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(np.log(x))/((x)**(2))

def objective_283(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d/((x)**(2))

def objective_284(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))+d*(np.e)**((-x))

def objective_285(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(x)**(2.5)

def objective_286(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*((x)**(3))

def objective_287(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(np.e)**(x)

def objective_288(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)*(np.log(x))

def objective_289(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*((np.log(x)))**(2)

def objective_290(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(x)/(np.log(x))

def objective_291(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)

def objective_292(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(np.log(x))

def objective_293(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d/(np.log(x))

def objective_294(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d/(x)**(0.5)

def objective_295(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(np.log(x))/(x)

def objective_296(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d/(x)

def objective_297(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d/(x)**(1.5)

def objective_298(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_299(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d/((x)**(2))

def objective_300(x, a, b, c, d):
    return a+b*(x)+c*((x)**(2))*(np.log(x))+d*(np.e)**((-x))

def objective_301(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*((x)**(3))

def objective_302(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(np.e)**(x)

def objective_303(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(x)**(0.5)*(np.log(x))

def objective_304(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*((np.log(x)))**(2)

def objective_305(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(x)/(np.log(x))

def objective_306(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(x)**(0.5)

def objective_307(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(np.log(x))

def objective_308(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d/(np.log(x))

def objective_309(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d/(x)**(0.5)

def objective_310(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(np.log(x))/(x)

def objective_311(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d/(x)

def objective_312(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d/(x)**(1.5)

def objective_313(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(np.log(x))/((x)**(2))

def objective_314(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d/((x)**(2))

def objective_315(x, a, b, c, d):
    return a+b*(x)+c*(x)**(2.5)+d*(np.e)**((-x))

def objective_316(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(np.e)**(x)

def objective_317(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(x)**(0.5)*(np.log(x))

def objective_318(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*((np.log(x)))**(2)

def objective_319(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(x)/(np.log(x))

def objective_320(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(x)**(0.5)

def objective_321(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(np.log(x))

def objective_322(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d/(np.log(x))

def objective_323(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d/(x)**(0.5)

def objective_324(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(np.log(x))/(x)

def objective_325(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d/(x)

def objective_326(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d/(x)**(1.5)

def objective_327(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(np.log(x))/((x)**(2))

def objective_328(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d/((x)**(2))

def objective_329(x, a, b, c, d):
    return a+b*(x)+c*((x)**(3))+d*(np.e)**((-x))

def objective_330(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(x)**(0.5)*(np.log(x))

def objective_331(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*((np.log(x)))**(2)

def objective_332(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(x)/(np.log(x))

def objective_333(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(x)**(0.5)

def objective_334(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(np.log(x))

def objective_335(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d/(np.log(x))

def objective_336(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d/(x)**(0.5)

def objective_337(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(np.log(x))/(x)

def objective_338(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d/(x)

def objective_339(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d/(x)**(1.5)

def objective_340(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(np.log(x))/((x)**(2))

def objective_341(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d/((x)**(2))

def objective_342(x, a, b, c, d):
    return a+b*(x)+c*(np.e)**(x)+d*(np.e)**((-x))

def objective_343(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*((np.log(x)))**(2)

def objective_344(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(x)/(np.log(x))

def objective_345(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(x)**(0.5)

def objective_346(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))

def objective_347(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d/(np.log(x))

def objective_348(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d/(x)**(0.5)

def objective_349(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/(x)

def objective_350(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d/(x)

def objective_351(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d/(x)**(1.5)

def objective_352(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_353(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d/((x)**(2))

def objective_354(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)*(np.log(x))+d*(np.e)**((-x))

def objective_355(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(x)/(np.log(x))

def objective_356(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(x)**(0.5)

def objective_357(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(np.log(x))

def objective_358(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d/(np.log(x))

def objective_359(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d/(x)**(0.5)

def objective_360(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(np.log(x))/(x)

def objective_361(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d/(x)

def objective_362(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d/(x)**(1.5)

def objective_363(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(np.log(x))/((x)**(2))

def objective_364(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d/((x)**(2))

def objective_365(x, a, b, c, d):
    return a+b*(x)+c*((np.log(x)))**(2)+d*(np.e)**((-x))

def objective_366(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d*(x)**(0.5)

def objective_367(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d*(np.log(x))

def objective_368(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d/(np.log(x))

def objective_369(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d/(x)**(0.5)

def objective_370(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d*(np.log(x))/(x)

def objective_371(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d/(x)

def objective_372(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d/(x)**(1.5)

def objective_373(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_374(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d/((x)**(2))

def objective_375(x, a, b, c, d):
    return a+b*(x)+c*(x)/(np.log(x))+d*(np.e)**((-x))

def objective_376(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d*(np.log(x))

def objective_377(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d/(np.log(x))

def objective_378(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d/(x)**(0.5)

def objective_379(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d*(np.log(x))/(x)

def objective_380(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d/(x)

def objective_381(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d/(x)**(1.5)

def objective_382(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_383(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d/((x)**(2))

def objective_384(x, a, b, c, d):
    return a+b*(x)+c*(x)**(0.5)+d*(np.e)**((-x))

def objective_385(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d/(np.log(x))

def objective_386(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d/(x)**(0.5)

def objective_387(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d*(np.log(x))/(x)

def objective_388(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d/(x)

def objective_389(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d/(x)**(1.5)

def objective_390(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_391(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d/((x)**(2))

def objective_392(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))+d*(np.e)**((-x))

def objective_393(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d/(x)**(0.5)

def objective_394(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d*(np.log(x))/(x)

def objective_395(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d/(x)

def objective_396(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d/(x)**(1.5)

def objective_397(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_398(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d/((x)**(2))

def objective_399(x, a, b, c, d):
    return a+b*(x)+c/(np.log(x))+d*(np.e)**((-x))

def objective_400(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d*(np.log(x))/(x)

def objective_401(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d/(x)

def objective_402(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d/(x)**(1.5)

def objective_403(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_404(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d/((x)**(2))

def objective_405(x, a, b, c, d):
    return a+b*(x)+c/(x)**(0.5)+d*(np.e)**((-x))

def objective_406(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/(x)+d/(x)

def objective_407(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/(x)+d/(x)**(1.5)

def objective_408(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/(x)+d*(np.log(x))/((x)**(2))

def objective_409(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/(x)+d/((x)**(2))

def objective_410(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/(x)+d*(np.e)**((-x))

def objective_411(x, a, b, c, d):
    return a+b*(x)+c/(x)+d/(x)**(1.5)

def objective_412(x, a, b, c, d):
    return a+b*(x)+c/(x)+d*(np.log(x))/((x)**(2))

def objective_413(x, a, b, c, d):
    return a+b*(x)+c/(x)+d/((x)**(2))

def objective_414(x, a, b, c, d):
    return a+b*(x)+c/(x)+d*(np.e)**((-x))

def objective_415(x, a, b, c, d):
    return a+b*(x)+c/(x)**(1.5)+d*(np.log(x))/((x)**(2))

def objective_416(x, a, b, c, d):
    return a+b*(x)+c/(x)**(1.5)+d/((x)**(2))

def objective_417(x, a, b, c, d):
    return a+b*(x)+c/(x)**(1.5)+d*(np.e)**((-x))

def objective_418(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/((x)**(2))+d/((x)**(2))

def objective_419(x, a, b, c, d):
    return a+b*(x)+c*(np.log(x))/((x)**(2))+d*(np.e)**((-x))

def objective_420(x, a, b, c, d):
    return a+b*(x)+c/((x)**(2))+d*(np.e)**((-x))

def objective_421(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*((x)**(2))

def objective_422(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*((x)**(2))*(np.log(x))

def objective_423(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(x)**(2.5)

def objective_424(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*((x)**(3))

def objective_425(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(np.e)**(x)

def objective_426(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(x)**(0.5)*(np.log(x))

def objective_427(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*((np.log(x)))**(2)

def objective_428(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(x)/(np.log(x))

def objective_429(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(x)**(0.5)

def objective_430(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(np.log(x))

def objective_431(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d/(np.log(x))

def objective_432(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d/(x)**(0.5)

def objective_433(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(np.log(x))/(x)

def objective_434(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d/(x)

def objective_435(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d/(x)**(1.5)

def objective_436(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(np.log(x))/((x)**(2))

def objective_437(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d/((x)**(2))

def objective_438(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(1.5)+d*(np.e)**((-x))

def objective_439(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*((x)**(2))*(np.log(x))

def objective_440(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(x)**(2.5)

def objective_441(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*((x)**(3))

def objective_442(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(np.e)**(x)

def objective_443(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(x)**(0.5)*(np.log(x))

def objective_444(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*((np.log(x)))**(2)

def objective_445(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(x)/(np.log(x))

def objective_446(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(x)**(0.5)

def objective_447(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(np.log(x))

def objective_448(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d/(np.log(x))

def objective_449(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d/(x)**(0.5)

def objective_450(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(np.log(x))/(x)

def objective_451(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d/(x)

def objective_452(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d/(x)**(1.5)

def objective_453(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(np.log(x))/((x)**(2))

def objective_454(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d/((x)**(2))

def objective_455(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))+d*(np.e)**((-x))

def objective_456(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(x)**(2.5)

def objective_457(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*((x)**(3))

def objective_458(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(np.e)**(x)

def objective_459(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)*(np.log(x))

def objective_460(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*((np.log(x)))**(2)

def objective_461(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(x)/(np.log(x))

def objective_462(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)

def objective_463(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(np.log(x))

def objective_464(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d/(np.log(x))

def objective_465(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d/(x)**(0.5)

def objective_466(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(np.log(x))/(x)

def objective_467(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d/(x)

def objective_468(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d/(x)**(1.5)

def objective_469(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_470(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d/((x)**(2))

def objective_471(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(2))*(np.log(x))+d*(np.e)**((-x))

def objective_472(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*((x)**(3))

def objective_473(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(np.e)**(x)

def objective_474(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(x)**(0.5)*(np.log(x))

def objective_475(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*((np.log(x)))**(2)

def objective_476(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(x)/(np.log(x))

def objective_477(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(x)**(0.5)

def objective_478(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(np.log(x))

def objective_479(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d/(np.log(x))

def objective_480(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d/(x)**(0.5)

def objective_481(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(np.log(x))/(x)

def objective_482(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d/(x)

def objective_483(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d/(x)**(1.5)

def objective_484(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(np.log(x))/((x)**(2))

def objective_485(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d/((x)**(2))

def objective_486(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(2.5)+d*(np.e)**((-x))

def objective_487(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(np.e)**(x)

def objective_488(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(x)**(0.5)*(np.log(x))

def objective_489(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*((np.log(x)))**(2)

def objective_490(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(x)/(np.log(x))

def objective_491(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(x)**(0.5)

def objective_492(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(np.log(x))

def objective_493(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d/(np.log(x))

def objective_494(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d/(x)**(0.5)

def objective_495(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(np.log(x))/(x)

def objective_496(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d/(x)

def objective_497(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d/(x)**(1.5)

def objective_498(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(np.log(x))/((x)**(2))

def objective_499(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d/((x)**(2))

def objective_500(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((x)**(3))+d*(np.e)**((-x))

def objective_501(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(x)**(0.5)*(np.log(x))

def objective_502(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*((np.log(x)))**(2)

def objective_503(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(x)/(np.log(x))

def objective_504(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(x)**(0.5)

def objective_505(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(np.log(x))

def objective_506(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d/(np.log(x))

def objective_507(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d/(x)**(0.5)

def objective_508(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(np.log(x))/(x)

def objective_509(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d/(x)

def objective_510(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d/(x)**(1.5)

def objective_511(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(np.log(x))/((x)**(2))

def objective_512(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d/((x)**(2))

def objective_513(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.e)**(x)+d*(np.e)**((-x))

def objective_514(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*((np.log(x)))**(2)

def objective_515(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(x)/(np.log(x))

def objective_516(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(x)**(0.5)

def objective_517(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))

def objective_518(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d/(np.log(x))

def objective_519(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d/(x)**(0.5)

def objective_520(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/(x)

def objective_521(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d/(x)

def objective_522(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d/(x)**(1.5)

def objective_523(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_524(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d/((x)**(2))

def objective_525(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)*(np.log(x))+d*(np.e)**((-x))

def objective_526(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(x)/(np.log(x))

def objective_527(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(x)**(0.5)

def objective_528(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(np.log(x))

def objective_529(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d/(np.log(x))

def objective_530(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d/(x)**(0.5)

def objective_531(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(np.log(x))/(x)

def objective_532(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d/(x)

def objective_533(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d/(x)**(1.5)

def objective_534(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(np.log(x))/((x)**(2))

def objective_535(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d/((x)**(2))

def objective_536(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*((np.log(x)))**(2)+d*(np.e)**((-x))

def objective_537(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d*(x)**(0.5)

def objective_538(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d*(np.log(x))

def objective_539(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d/(np.log(x))

def objective_540(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d/(x)**(0.5)

def objective_541(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d*(np.log(x))/(x)

def objective_542(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d/(x)

def objective_543(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d/(x)**(1.5)

def objective_544(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_545(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d/((x)**(2))

def objective_546(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)/(np.log(x))+d*(np.e)**((-x))

def objective_547(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d*(np.log(x))

def objective_548(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d/(np.log(x))

def objective_549(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d/(x)**(0.5)

def objective_550(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d*(np.log(x))/(x)

def objective_551(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d/(x)

def objective_552(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d/(x)**(1.5)

def objective_553(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_554(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d/((x)**(2))

def objective_555(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(x)**(0.5)+d*(np.e)**((-x))

def objective_556(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d/(np.log(x))

def objective_557(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d/(x)**(0.5)

def objective_558(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d*(np.log(x))/(x)

def objective_559(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d/(x)

def objective_560(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d/(x)**(1.5)

def objective_561(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_562(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d/((x)**(2))

def objective_563(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))+d*(np.e)**((-x))

def objective_564(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d/(x)**(0.5)

def objective_565(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d*(np.log(x))/(x)

def objective_566(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d/(x)

def objective_567(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d/(x)**(1.5)

def objective_568(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_569(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d/((x)**(2))

def objective_570(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(np.log(x))+d*(np.e)**((-x))

def objective_571(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d*(np.log(x))/(x)

def objective_572(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d/(x)

def objective_573(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d/(x)**(1.5)

def objective_574(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_575(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d/((x)**(2))

def objective_576(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(0.5)+d*(np.e)**((-x))

def objective_577(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)+d/(x)

def objective_578(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)+d/(x)**(1.5)

def objective_579(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)+d*(np.log(x))/((x)**(2))

def objective_580(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)+d/((x)**(2))

def objective_581(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/(x)+d*(np.e)**((-x))

def objective_582(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)+d/(x)**(1.5)

def objective_583(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)+d*(np.log(x))/((x)**(2))

def objective_584(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)+d/((x)**(2))

def objective_585(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)+d*(np.e)**((-x))

def objective_586(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(1.5)+d*(np.log(x))/((x)**(2))

def objective_587(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(1.5)+d/((x)**(2))

def objective_588(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/(x)**(1.5)+d*(np.e)**((-x))

def objective_589(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/((x)**(2))+d/((x)**(2))

def objective_590(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c*(np.log(x))/((x)**(2))+d*(np.e)**((-x))

def objective_591(x, a, b, c, d):
    return a+b*(x)*(np.log(x))+c/((x)**(2))+d*(np.e)**((-x))

def objective_592(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*((x)**(2))*(np.log(x))

def objective_593(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(x)**(2.5)

def objective_594(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*((x)**(3))

def objective_595(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(np.e)**(x)

def objective_596(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(x)**(0.5)*(np.log(x))

def objective_597(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*((np.log(x)))**(2)

def objective_598(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(x)/(np.log(x))

def objective_599(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(x)**(0.5)

def objective_600(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(np.log(x))

def objective_601(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d/(np.log(x))

def objective_602(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d/(x)**(0.5)

def objective_603(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(np.log(x))/(x)

def objective_604(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d/(x)

def objective_605(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d/(x)**(1.5)

def objective_606(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(np.log(x))/((x)**(2))

def objective_607(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d/((x)**(2))

def objective_608(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))+d*(np.e)**((-x))

def objective_609(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(x)**(2.5)

def objective_610(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*((x)**(3))

def objective_611(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(np.e)**(x)

def objective_612(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)*(np.log(x))

def objective_613(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*((np.log(x)))**(2)

def objective_614(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(x)/(np.log(x))

def objective_615(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(x)**(0.5)

def objective_616(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(np.log(x))

def objective_617(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d/(np.log(x))

def objective_618(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d/(x)**(0.5)

def objective_619(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(np.log(x))/(x)

def objective_620(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d/(x)

def objective_621(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d/(x)**(1.5)

def objective_622(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_623(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d/((x)**(2))

def objective_624(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(2))*(np.log(x))+d*(np.e)**((-x))

def objective_625(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*((x)**(3))

def objective_626(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(np.e)**(x)

def objective_627(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(x)**(0.5)*(np.log(x))

def objective_628(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*((np.log(x)))**(2)

def objective_629(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(x)/(np.log(x))

def objective_630(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(x)**(0.5)

def objective_631(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(np.log(x))

def objective_632(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d/(np.log(x))

def objective_633(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d/(x)**(0.5)

def objective_634(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(np.log(x))/(x)

def objective_635(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d/(x)

def objective_636(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d/(x)**(1.5)

def objective_637(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(np.log(x))/((x)**(2))

def objective_638(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d/((x)**(2))

def objective_639(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(2.5)+d*(np.e)**((-x))

def objective_640(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(np.e)**(x)

def objective_641(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(x)**(0.5)*(np.log(x))

def objective_642(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*((np.log(x)))**(2)

def objective_643(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(x)/(np.log(x))

def objective_644(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(x)**(0.5)

def objective_645(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(np.log(x))

def objective_646(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d/(np.log(x))

def objective_647(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d/(x)**(0.5)

def objective_648(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(np.log(x))/(x)

def objective_649(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d/(x)

def objective_650(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d/(x)**(1.5)

def objective_651(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(np.log(x))/((x)**(2))

def objective_652(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d/((x)**(2))

def objective_653(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((x)**(3))+d*(np.e)**((-x))

def objective_654(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(x)**(0.5)*(np.log(x))

def objective_655(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*((np.log(x)))**(2)

def objective_656(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(x)/(np.log(x))

def objective_657(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(x)**(0.5)

def objective_658(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(np.log(x))

def objective_659(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d/(np.log(x))

def objective_660(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d/(x)**(0.5)

def objective_661(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(np.log(x))/(x)

def objective_662(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d/(x)

def objective_663(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d/(x)**(1.5)

def objective_664(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(np.log(x))/((x)**(2))

def objective_665(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d/((x)**(2))

def objective_666(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.e)**(x)+d*(np.e)**((-x))

def objective_667(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*((np.log(x)))**(2)

def objective_668(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(x)/(np.log(x))

def objective_669(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(x)**(0.5)

def objective_670(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))

def objective_671(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d/(np.log(x))

def objective_672(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d/(x)**(0.5)

def objective_673(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/(x)

def objective_674(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d/(x)

def objective_675(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d/(x)**(1.5)

def objective_676(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_677(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d/((x)**(2))

def objective_678(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)*(np.log(x))+d*(np.e)**((-x))

def objective_679(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(x)/(np.log(x))

def objective_680(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(x)**(0.5)

def objective_681(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(np.log(x))

def objective_682(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d/(np.log(x))

def objective_683(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d/(x)**(0.5)

def objective_684(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(np.log(x))/(x)

def objective_685(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d/(x)

def objective_686(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d/(x)**(1.5)

def objective_687(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(np.log(x))/((x)**(2))

def objective_688(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d/((x)**(2))

def objective_689(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*((np.log(x)))**(2)+d*(np.e)**((-x))

def objective_690(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d*(x)**(0.5)

def objective_691(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d*(np.log(x))

def objective_692(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d/(np.log(x))

def objective_693(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d/(x)**(0.5)

def objective_694(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d*(np.log(x))/(x)

def objective_695(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d/(x)

def objective_696(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d/(x)**(1.5)

def objective_697(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_698(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d/((x)**(2))

def objective_699(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)/(np.log(x))+d*(np.e)**((-x))

def objective_700(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d*(np.log(x))

def objective_701(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d/(np.log(x))

def objective_702(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d/(x)**(0.5)

def objective_703(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d*(np.log(x))/(x)

def objective_704(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d/(x)

def objective_705(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d/(x)**(1.5)

def objective_706(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_707(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d/((x)**(2))

def objective_708(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(x)**(0.5)+d*(np.e)**((-x))

def objective_709(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d/(np.log(x))

def objective_710(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d/(x)**(0.5)

def objective_711(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d*(np.log(x))/(x)

def objective_712(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d/(x)

def objective_713(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d/(x)**(1.5)

def objective_714(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_715(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d/((x)**(2))

def objective_716(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))+d*(np.e)**((-x))

def objective_717(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d/(x)**(0.5)

def objective_718(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d*(np.log(x))/(x)

def objective_719(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d/(x)

def objective_720(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d/(x)**(1.5)

def objective_721(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d*(np.log(x))/((x)**(2))

def objective_722(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d/((x)**(2))

def objective_723(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(np.log(x))+d*(np.e)**((-x))

def objective_724(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d*(np.log(x))/(x)

def objective_725(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d/(x)

def objective_726(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d/(x)**(1.5)

def objective_727(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d*(np.log(x))/((x)**(2))

def objective_728(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d/((x)**(2))

def objective_729(x, a, b, c, d):
    return a+b*(x)**(1.5)+c/(x)**(0.5)+d*(np.e)**((-x))

def objective_730(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))/(x)+d/(x)

def objective_731(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))/(x)+d/(x)**(1.5)

def objective_732(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))/(x)+d*(np.log(x))/((x)**(2))

def objective_733(x, a, b, c, d):
    return a+b*(x)**(1.5)+c*(np.log(x))/(x)+d/((x)**(2))

def objective_734(x, a, b, c, d):
...
def objective_2702(x, a, b, c, d, e, f):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))+e*((x)**(4))+f*((x)**(5))

def objective_2703(x, a, b, c, d, e, f, g):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))+e*((x)**(4))+f*((x)**(5))+g*((x)**(6))

def objective_2704(x, a, b, c, d, e, f, g, h):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))+e*((x)**(4))+f*((x)**(5))+g*((x)**(6))+h*((x)**(7))

def objective_2705(x, a, b, c, d, e, f, g, h, i):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))+e*((x)**(4))+f*((x)**(5))+g*((x)**(6))+h*((x)**(7))+i*((x)**(8))

def objective_2706(x, a, b, c, d, e, f, g, h, i, j):
    return a+b*(x)+c*((x)**(2))+d*((x)**(3))+e*((x)**(4))+f*((x)**(5))+g*((x)**(6))+h*((x)**(7))+i*((x)**(8))+j*((x)**(9))

def objective_2707(x, a, b, c, d, e, f, g, h, i, j, k):
