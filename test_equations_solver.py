...
class TestEquationsSolverRunAndEvaluation2DAnd3D(unittest.TestCase):
    def test_solver_runs_correctly(self) -> None:
        ...
        # for i in formula_square_results_2d:
        #     print((i[0], np.round(i[1], 3)))
        # print()
        # for i in formula_sqrt_results_2d:
        #     print((i[0], np.round(i[1], 3)))
        # print()
        # for i in formula_simple_results_2d:
        #     print((i[0], np.round(i[1], 3)))
        # print()
        # for i in formula_ln_results_2d:
        #     print((i[0], np.round(i[1], 3)))
        # print()
        # for i in formula_inv_results_2d:
        #     print((i[0], np.round(i[1], 3)))
        # print()
